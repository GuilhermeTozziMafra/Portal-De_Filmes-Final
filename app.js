...
function createImageContainer(imageUrl, id) {
    ...
    const externUrl = `https://www.themoviedb.org/movie/${id}?language=pt-BR`

    const movieElement = `
        <img src="${imageUrl}" alt="" onClick="window.location.href='${externUrl}'" data-movie-id="${id}">
    `;
...
document.onclick = function (event) {
    ...
    // let inputSearch = document.getElementById('exampleInputEmail1').value
